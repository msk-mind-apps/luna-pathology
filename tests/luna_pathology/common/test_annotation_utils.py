...
from luna_pathology.common.annotation_utils import *

SLIDEVIEWER_API_URL = "http://test-slideviewer-url.com/"
SLIDE_BMP_DIR = "tests/luna_pathology/common/testdata/project/regional_bmps"
SLIDE_NPY_DIR = "tests/luna_pathology/common/testdata/project/regional_npys"
TMP_ZIP_DIR = "tests/luna_pathology/common/testdata/project/regional_tmp"
BMP_FILE_PATH= "tests/luna_pathology/common/testdata/project/regional_bmps/1_123/123_user_SVBMP-01c9ea8d50971412600b83d4918d3888818b77792f4c40a66861bbd586ae5d51_annot.bmp"
NPY_FILE_PATH = "tests/luna_pathology/common/testdata/project/regional_npys/1_123/123_user_SVBMP-01c9ea8d50971412600b83d4918d3888818b77792f4c40a66861bbd586ae5d51_annot.npy"
SLIDE_STORE_DIR = "tests/luna_pathology/common/testdata/project/slides"
...
def test_get_slide_bitmap(requests_mock):
    requests_mock.get("http://test-slideviewer-url.com/slides/user@mskcc.org/projects;1;1;123.svs/getLabelFileBMP",
                      content=Path('tests/luna_pathology/common/testdata/input/label.zip').read_bytes())
...
def test_convert_slide_bitmap_to_geojson():
    outputs = [
        ...
        {'sv_project_id': '1', 'slideviewer_path': '1;123.svs', 'slide_id': '123', 'user': 'user',
         'bmp_filepath': 'tests/luna_pathology/common/testdata/project/regional_bmps/1_123/123_user_SVBMP-01c9ea8d50971412600b83d4918d3888818b77792f4c40a66861bbd586ae5d51_annot.bmp',
         'npy_filepath': 'tests/luna_pathology/common/testdata/project/regional_npys/1_123/123_user_SVBMP-01c9ea8d50971412600b83d4918d3888818b77792f4c40a66861bbd586ae5d51_annot.npy',
